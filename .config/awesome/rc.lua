...
awful.util.tagnames = { "www", "sys", "dev", "com", "mus" }
...
globalkeys = my_table.join(
    ...
    -- TODO: See where we can put the weather widget and then view it from this
    ...
    awful.key({ modkey }, "t", function () awful.spawn(file_browser) end,
    ...
    awful.key({ modkey }, "x", function ()
            os.execute(string.format("dmenu_run -i -fn 'Terminus (TTF)' -nb '%s' -nf '%s' -sb '%s' -sf '%s'", 
    ...
    -- rofi
    awful.key({ modkey }, "x", function ()
            os.execute(string.format("rofi -show %s -display-drun 'Run'",
            'drun'))
        end,
